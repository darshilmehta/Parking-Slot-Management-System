...
<body>
	<div align="center" class="header">
		<h1 class="header-content">Client Short term Pass</h1>
	</div>
	...
	<%
		...
		String Squery = "SELECT * FROM regular_reserve WHERE customer_id='"+customerID+"'";
		PreparedStatement psl = con.prepareStatement(Squery);
	...
	%>
	<tr>
		<td class="a"><%=rsl.getString("regular_reserve_id") %></td>
