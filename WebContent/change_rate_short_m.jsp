...
<body>
	...
	<%
		...
		int newCost = Integer.parseInt(request.getParameter("new_cost"));
		...
		String query = "SELECT cost FROM regular_reserve_cost WHERE duration_in_mins='"+d+"' AND vehicle_type='"+v+"'";
		...
		String q = "UPDATE regular_reserve_cost SET cost='"+newCost+"' WHERE duration_in_mins='"+d+"' AND vehicle_type='"+v+"'";
